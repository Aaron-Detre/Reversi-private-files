 ...
 * {@link Hexagon} object for efficient rendering and interaction processing.
 *
...
public class ReversiPanel extends JPanel {
  ...
  private CubicPosn selectedPosn;

  private final Map<CubicPosn, Hexagon> hexagonMap = new HashMap<>();
  ...
  protected void paintComponent(Graphics g) {
    ...
    this.drawHexagonalBoard(g2d); // Example coordinates and size
  }
   ...
   */
  private void drawHexagonalBoard(Graphics2D g2d) {
   ...
   */
  private void drawCenteredCircle(Graphics2D g, double x, double y, double radius) {
  ...
  public void renderSelection(int x, int y) {
    ...
    for (Map.Entry<CubicPosn, Hexagon> entry : hexagonMap.entrySet()) {
